...
export const TriggerEdit = () => {
    ...
    return (
        <ResourceEdit<Trigger> resource='triggers'>
            {() => (
                <>
                    <Form.Item<Trigger>
                        name='name'
                    ...
                    <Form.Item<Trigger>
                        ...
                        normalize={(value? : string[]) => value && Array.isArray(value) ? value.map(notificationName => notifications?.data?.find(notification => notification.name === notificationName)).map(notification => notification?.id).join(',') : value}>
                        <Select
                            allowClear
                            options={
